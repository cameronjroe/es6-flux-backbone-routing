...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppComponent = _interopRequire(__webpack_require__(1));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// stores
	var AppStore = _interopRequire(__webpack_require__(3));
	
	var RouterStore = _interopRequire(__webpack_require__(4));
	
	// components
	var NavComponent = _interopRequire(__webpack_require__(5));
	
	var PageComponent = _interopRequire(__webpack_require__(6));
	...
	var AppComponent = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(PageComponent, { page: this.state.appState.page })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * App Store
	 */
	var Backbone = _interopRequire(__webpack_require__(35));
	
	var AppDispatcher = _interopRequire(__webpack_require__(9));
	
	var RouteDispatcher = _interopRequire(__webpack_require__(10));
	...
	var AppStore = Backbone.Model.extend({
	  ...
	  initialize: function initialize() {
	    var _this = this;
	    this.dispatchId = RouteDispatcher.register(function (payload) {
	      return _this.handleDispatch(payload);
	    });
	  },
	
	  handleDispatch: function handleDispatch(payload) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RouteStore = Backbone.Model.extend({
	  ...
	  updateState: function updateState(route) {
	    console.log(route);
	...
	var RouterStore = new RouteStore({ home: "home", detail: "detail" });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppActions = _interopRequire(__webpack_require__(8));
	        ...
	        React.createElement(
	          ...
	          this.routes.map(function (route) {
	            return React.createElement(
	              ...
	              React.createElement(
	                "a",
	                { href: "#", onClick: _this.handleRoute, "data-route": route },
	                route
	              )
	            );
	          })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppActions = {
	   ...
	   * Dispatch Route
	   */
	  dispatchRoute: function dispatchRoute(route) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * App Dispatcher
	 */
	var Flux = _interopRequire(__webpack_require__(95));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(143), __webpack_require__(141), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
